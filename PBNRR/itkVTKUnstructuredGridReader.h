/*=========================================================================
  ...
  Module:    $RCSfile: itkVTKUnstructuredGridReader.h,v $
  Language:  C++
 ...
 *
 * Caveat1: itkVTKUnstructuredGridReader can only read tetrahedral meshes.
 *          Use vtkTriangleFilter to convert your mesh to a triangle mesh.
 * Caviet2: itkVTKUnstructuredGridReader can only read vtk legacy files.
 * Caveat3: itkVTKUnstructuredGridReader cannot read binary vtk files.
 */
template <class TOutputMesh>
class VTKUnstructuredGridReader : public MeshSource<TOutputMesh>
{
public:
  ...
  itkTypeMacro(VTKUnstructuredGridReader, MeshSource);
  ...
  /** Define the tetrahedron cell types */
  typedef TetrahedronCell<CellType>   TetrahedronCellType;
  /** Define the vertex cell types */
  typedef VertexCell<CellType>   VertexCellType;
...
private:
  VTKUnstructuredGridReader(const Self&); // purposely not implemented
...
#include "itkVTKUnstructuredGridReader.hxx"
#endif

#endif //_itkVTKUnstructuredGridReader_h
